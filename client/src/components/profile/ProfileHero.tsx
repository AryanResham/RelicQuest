...
export default function ProfileHero({
  ...
  return (
    <div className="mt-4 px-4 md:px-10 lg:px-20 py-8 md:py-12 bg-[var(--card-dark)] rounded-xl border-[var(--border)]">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="hidden xl:flex flex-col gap-3">
          {isSeller ? (
            <Link 
              to="/list-item"
              className="flex items-center justify-center gap-2 bg-primary hover:bg-primary/80 text-white font-bold py-2.5 px-6 rounded-lg transition-colors"
            >
